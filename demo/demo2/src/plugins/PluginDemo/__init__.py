# -*- coding: utf-8 -*-
"""
    ProcessName_XXX.plugins.PluginDemo
    ~~~~~~~~~~~~~~

    This is a demo for plugin.
    Your Plugin Description.

    :copyright: (c) 2017 by Author_Name_XXX.
...
class PluginDemoMain(PluginBase):
    ...
    def _hook(self, **kwargs):
        self.logger.debug("I am a demo for after cep, get redis all key")
    ...
    def register_bep(self):
        ...
        #bep = {"prefix": "/pluginDemoApi", "blueprint": pluginApi_blueprint}
        return bep
