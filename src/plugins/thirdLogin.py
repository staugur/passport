...
def Instagram_Login_Page_Url(INSTAGRAM_APP_ID, INSTAGRAM_REDIRECT_URI):
    ''' Redirect GitHub Landing Page URL '''
    return Splice(scheme="https", netloc="api.instagram.com", path="/oauth/authorize/", query={"client_id": INSTAGRAM_APP_ID, "redirect_uri": INSTAGRAM_REDIRECT_URI, "response_type": "code", "force_classic_login": ""}).geturl
